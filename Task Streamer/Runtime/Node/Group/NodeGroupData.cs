...
#if UNITY_EDITOR
    [Serializable]
    public class NodeGroupData : ScriptableObject, ISerializationCallbackReceiver
    {
        public string title;
        ...
        public void ChangeNodePosition(Vector2 newPosition)
        {
            ...
            else
            {
                ...
                Undo.RecordObject(this, "Task Streamer (NodeGroupViewPositionChanged)");
                position = newPosition;
        ...
        public void AddNodeGuid(UGUID guid)
        {
            ...
            Undo.RecordObject(this, "Task Streamer (AddNodeGuidToGroup)");
        ...
        public void RemoveNodeGuid(UGUID guid)
        {
            ...
            Undo.RecordObject(this, "Task Streamer (RemoveNodeGuidToGroup)");
