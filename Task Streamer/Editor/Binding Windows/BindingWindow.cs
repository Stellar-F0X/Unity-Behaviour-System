...
namespace TaskStreamer.Tool
{
    ...
    public sealed class BindingWindow : ScriptableObject, ISearchWindowProvider
    {
        ...
        /// <summary>Enables selection of a search tree entry and invokes the corresponding creation callback.</summary>
        /// <param name="entry">The selected search tree entry.</param>
        /// <param name="context">The context containing screen position information.</param>
        /// <returns>Returns true if the entry is successfully processed; otherwise, false.</returns>
