...
namespace TaskStreamer.Tool
{
    ...
    internal partial class TSEditor : EditorWindow
    {
        ...
        public static TSEditor Instance
        {
            get;
            private set;
        }
        ...
        /// <summary> NodeScriptCreationPopup 클래스의 인스턴스를 나타냅니다. </summary>
        public ScriptCreationPopup creationPopup 
        {
            get;
            private set; 
        }
...
#region Static Methods
        ...
        [MenuItem("Assets/Create/Task Streamer/FSM Asset", false, 0)]
        public static void CreateFSMGraphAsset()
        {
            TSObjectFactory.CreateGraphAssetFile(nameof(GraphType.FSM), GraphType.FSM, "FSM");
        }


        [MenuItem("Assets/Create/Task Streamer/BT Asset", false, 0)]
        public static void CreateBTGraphAsset()
        {
            TSObjectFactory.CreateGraphAssetFile(nameof(GraphType.BT), GraphType.BT, "BT");
        }
        ...
        private static bool OnOpenAsset(int instanceID, int line)
        {
            ...
            {
                TSEditor.OpenWindow(graphAsset);
                return true;
            }
...
#region Create GUIs
        ...
        private void CreateGUI()
        {
            ...
            this.creationPopup = new ScriptCreationPopup();
        ...
        {
            TSEditor.isLoadingTreeToView = false;
            TSEditor.canEditGraph = false;
        ...
        public bool ChangeGraph(Graph graph, bool isSubGraph = false)
        {
            ...
            TSEditor.canEditGraph = !Application.isPlaying;
        ...
        {
            bool hasOpenInstances = HasOpenInstances<TSEditor>();
        ...
        private void OnChangeBlackboardAsset(ChangeEvent<Object> evt)
        {
            ...
            BlackboardAsset fresh = TSObjectFactory.CloneBlackboardAssetInstance(evt.newValue as BlackboardAsset);
