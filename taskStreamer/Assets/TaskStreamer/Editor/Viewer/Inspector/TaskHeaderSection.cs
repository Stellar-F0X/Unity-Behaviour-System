...
namespace TaskStreamer.Tool
{
    ...
    internal class TaskHeaderSection : VisualElement, IRefreshablePanel
    {
        /// <summary> 작업(Task)의 기본 속성을 표시하고 편집할 수 있는 UI 패널입니다. </summary>
        public TaskHeaderSection(Task targetTask, Action<string> renamingCallback)
        {
            TSUIElementSettings.instance.TaskHeaderSection.CloneTree(this);
