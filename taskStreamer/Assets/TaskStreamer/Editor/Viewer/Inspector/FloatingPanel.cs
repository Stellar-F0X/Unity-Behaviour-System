...
namespace TaskStreamer.Tool
{
	internal abstract class FloatingPanel : VisualElement
	{
		...
		{
			this.RegisterCallbackOnce<GeometryChangedEvent>(this.DelayedInitialize);
		}
		...
		protected virtual void DelayedInitialize(GeometryChangedEvent evt)
		{
			...
			_resizer.style.backgroundImage = TSUIElementSettings.instance.ResizeHandleImage;
		...
		private void OnWheelEvent(WheelEvent evt)
		{
			...
			if (this.container != null)
			{
				...
				float lowValue = scrollView.verticalScroller.lowValue;
				float highValue = scrollView.verticalScroller.highValue;
				...
				scrollOffset.y = Mathf.Clamp(moveHeight, lowValue, highValue);
