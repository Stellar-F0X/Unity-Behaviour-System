...
namespace TaskStreamer.Tool
{
	...
	internal class ConditionSection : VisualElement
	{
		public ConditionSection()
		{
			TSUIElementSettings.instance.ConditionSection.CloneTree(this);
		...
		public event Action<ConditionSection> OnDeleteRequested;
		...
		public void Setup(Condition condition)
		{
			...
			this._deleteButton.enabledSelf = TSEditor.canEditGraph;
