...
{
    internal class BBVariableFieldsPanel : VisualElement, IRefreshablePanel
    {
        public BBVariableFieldsPanel(List<VariableHandle> variableHandles)
        {
            TSUIElementSettings.instance.BBVariableFieldsPanel.CloneTree(this);
            ...
            this._fieldListView.makeItem += this.MakeItem;
        ...
        private bool TryCreateFieldElement(VariableHandle handle, out VisualElement field)
        {
            switch (handle.initialValue)
            {
                ...
                case BlackboardBasedCondition: field = new ConditionsPanel(handle); break;
