...
namespace TaskStreamer.Tool
{
	...
	internal class BBVariableField<TValue, TBindableField> : VisualElement, INotifyValueChanged<TValue>, IRefreshableField where TBindableField : BindableElement, INotifyValueChanged<TValue>, new()
	{
		protected BBVariableField()
		{
			TSUIElementSettings.instance.BBVariableField.CloneTree(this);
		...
		public BBVariableField(VariableHandle variableHandle) : this()
		{
			...
			this._unlinkButton.iconImage = TSUIElementSettings.instance.DeleteButtonImage;
			...
			this._linkToSharedButton.iconImage = TSUIElementSettings.instance.BindingButtonImage;
