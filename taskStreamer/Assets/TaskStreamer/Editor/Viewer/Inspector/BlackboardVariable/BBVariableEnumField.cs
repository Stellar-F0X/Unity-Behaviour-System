...
namespace TaskStreamer.Tool
{
    ...
    internal class BBVariableEnumField<TEnumField> : BBVariableField<Enum, TEnumField> where TEnumField : BaseField<Enum>, new()
    {
        public BBVariableEnumField(VariableHandle variableHandle) : base(variableHandle)
        {
