...
namespace TaskStreamer.Runtime.FSM
{
	...
	public abstract class StateBase : NodeBase, IMissingTaskRemovable
	{
		...
		/// <summary>
		/// Missing Object가 된 Transition을 제거합니다.
		/// Condition은 MissingObjectCleaner의 BlackboardBasedCondition Adapter에서 처리합니다.
		/// </summary>
		/// <returns>제거된 Transition 개수</returns>
		int IMissingTaskRemovable.RemoveMissingTasks()
		{
			return _transitions.RemoveAll(static t => t is null || t.sourceNode is null || t.destinationNode is null);
		}
#endif
	}
}