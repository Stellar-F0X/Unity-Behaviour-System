...
namespace TaskStreamer.Runtime
{
	...
	///         → Condition 동기화
	/// </summary>
	internal class BBSynchronizer : ReadableVisitorBase,
	...
	{
		public BBSynchronizer(GraphContext context)
		{
			_context = context;
		}
		...
		public void Visit<TContainer>(in VisitContext<TContainer> context, ref TContainer container, BlackboardVariable value)
		{
			...
			BlackboardVariable synced = _context.blackboard.SyncWithBlackboard(value);
