...
namespace TaskStreamer.Runtime
{
	...
	public class TaskGraphFieldCollector : TaskGraphVisitorBase
	{
		...
		public TaskGraphFieldCollector(PriorityQueue<VariableHandle> propertiesContainer)
		{
		...
		protected override void VisitProperty<TContainer, TValue>(Property<TContainer, TValue> property, ref TContainer container, ref TValue value)
		{
			...
			var getter = (ValueGetter<TContainer, TValue>)property.GetValue;
			Assert.IsNotNull(getter);
			
			var setter = (ValueSetter<TContainer, TValue>)property.SetValue;
			Assert.IsNotNull(setter);
			
			IEnumerable<Attribute> attrs = property.GetAttributes();

			VariableHandle handle = new VariableHandle(property.Name, value, container, typeof(TValue), attrs, getter, setter);
